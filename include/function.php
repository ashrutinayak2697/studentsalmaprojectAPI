<?php
	...
	function binarytoimage_provider($binaryString, $username, $user_id=null,$flag=null)
	{ 
		$dirswfl = "productimage/".$pro_id;
	...
	function binarytoimage_subcat($binaryString, $username, $user_id=null,$flag=null)
	{ 
		$dirswfl = "subimage/".$s_id;
	...
	{ 
		$dirswfl = "upload_product_image/".$user_id;
		...
		$target = "upload_product_image/".$user_id."/";
		$binaryString = base64_decode($binaryString);
